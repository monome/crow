...
assert(s2() == 0) -- weird starting point (essentially -1 which wraps to .len - 1)
assert(s2() == 9)
assert(s2() == 6)
assert(s2() == 3)
...
-- local s12 = s({1,2,3}, s.step(s{1,1,-1})) -- 2 steps forward, 1 step back
-- local s12 = s.new{1,2,3}:step(s{1,1,-1}) -- 2 steps forward, 1 step back
-- for i=1,8 do print(s12()) end
-- assert(s12() == 1)
-- assert(s12() == 2)
-- assert(s12() == 1)
-- assert(s12() == 2)
...
for i=1,5 do print();print(s8()) end
assert(s8() == 1)
assert(s8() == 1)
assert(s8() == 2)
assert(s8() == 1)
