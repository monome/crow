...
Cal = {
    ...
    -- mapping from lua names to hardware addresses
    sources = {[1]=3
              ,[2]=2
              ,[3]=1
              ,[4]=0
    ...
    save = function() calibrate_save() end
}
...
function Cal.source(chan)
    chan = Cal.sources[chan]
    if chan then calibrate_source(chan)
    else print'invalid source' end
end
